...
# Initialize ResNet-18 with random weights (training from scratch)
...
optimizer = Lion(model.parameters(), lr=0.0001, weight_decay=1e-2)
...
torch.save(model.state_dict(), "Lion_resnet_trained.pth")
print("Training complete! Model saved as Lion_resnet_trained.pth")
